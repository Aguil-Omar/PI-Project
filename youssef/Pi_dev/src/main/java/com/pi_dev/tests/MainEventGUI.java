...
public class MainEventGUI extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        //FXMLLoader loaderAjout = new FXMLLoader(getClass().getResource("/InterfaceEspace/AjoutTypeEspace.fxml"));
        //FXMLLoader loaderAjout = new FXMLLoader(getClass().getResource("/InterfaceEspace/AjoutEspace.fxml"));
        //FXMLLoader loaderAjout = new FXMLLoader(getClass().getResource("/InterfaceComment/comment.fxml"));
        //FXMLLoader loaderAjout = new FXMLLoader(getClass().getResource("/InterfaceComment/statistics.fxml"));
     // FXMLLoader loaderAjout = new FXMLLoader(getClass().getResource("/InterfaceUtilisateur/ajoutUtilisateur.fxml"));
       FXMLLoader loaderAjout = new FXMLLoader(getClass().getResource("/InterfaceUtilisateur/signin.fxml"));
     //FXMLLoader loaderAjout = new FXMLLoader(getClass().getResource("/InterfaceEvenement/PageAcceuil.fxml"));
    // FXMLLoader loaderAjout = new FXMLLoader(getClass().getResource("/InterfaceEvenement/AjoutEvenement.fxml"));
     // FXMLLoader loaderAjout = new FXMLLoader(getClass().getResource("/InterfaceMateriel/MainInterface.fxml"));
     //   FXMLLoader loaderAjout = new FXMLLoader(getClass().getResource("/InterfaceUtilisateur/sdg);

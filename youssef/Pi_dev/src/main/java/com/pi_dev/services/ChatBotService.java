...
public class ChatBotService {
    ...
    private static final String API_KEY = "AIzaSyAkRZjNUAfLVHPBKmTHy5BycCOdf02Ishs"; // Replace with a secure way of storing it
    private static final String API_URL = "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=" + API_KEY;

    public String getResponse(String userMessage) {
        try {
            AdminService AD= AdminService.getInstance();
            Utilisateur loggedUser = AD.getLoggedUser();
            ...
            String requestBody = "{"
                    ...
                    + "this is username for added to your friendly chat UserName: "+loggedUser.getNom()+" this is the user message " + userMessage + "\"}]}],"
